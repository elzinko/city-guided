...
Then('I should see search results for {string} in the bottom sheet', async function (this: CityGuidedWorld, query: string) {
...
Then('I should see search results for {string}', async function (this: CityGuidedWorld, query: string) {
...
Then('the search query should be cleared', async function (this: CityGuidedWorld) {
  ...
  let searchInput = this.page!.locator('[data-testid*="search-input"], input[type="text"], textbox').first();
