...
export class CityGuidedStagingStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    userData.addCommands(
      ...
      '',
      '# Install Docker Compose v2 (plugin) - idempotent',
      ...
      'fi',
      '',
      '# Install Docker Buildx (required by Docker Compose v2 for building images) - idempotent',
      ...
      'fi',
      '',
      '# Install plugins for ec2-user (idempotent)',
